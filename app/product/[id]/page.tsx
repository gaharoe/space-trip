...
import LoaderCircleBar from "@/components/LoaderCircleBar"
            ...
            <div className="flex flex-col">
                ...
                <div className={`flex flex-col p-5 gap-3 ${zalando.className}`}>
                    <div className="flex justify-between items-center">
                        <p className="text-4xl text-emerald-500 font-bold"><span className="text-lg">Rp </span>{product ? parseInt(product?.price).toLocaleString() : "??????"}</p>
                        <LikeButton/>
                    </div>
